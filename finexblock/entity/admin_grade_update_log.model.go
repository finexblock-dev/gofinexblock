...
type AdminGradeUpdateLog struct {
	...
	PrevGrade  string    `json:"prevGrade,omitempty" gorm:"not null;type:enum('S','M','N');comment:'수정 전 등급';"`
	CurrGrade  string    `json:"currGrade,omitempty" gorm:"not null;type:enum('S','M','N');comment:'수정 후 등급';"`
