...
type OrderBook struct {
	...
	OrderType     types.OrderType   `gorm:"not null;type:enum('BID', 'ASK');comment:'bid or ask'"`
	Status        types.OrderStatus `gorm:"not null;comment:'주문 상태';type:enum('CANCELLED', 'PLACED', 'FULFILLED', 'PARTIAL_FILLED');"`
