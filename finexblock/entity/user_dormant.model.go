...
type UserDormant struct {
	...
	MetadataProfile interface{} `gorm:"type:json;comment:'프로필 메타데이터';not null;" json:"metadataProfile"`
	MetadataUser    interface{} `gorm:"type:json;comment:'유저 메타데이터';not null;" json:"metadataUser"`
