...
type Service interface {
	...
	FindSymbolByName(tx *gorm.DB, name string) (*entity.OrderSymbol, error)
	FindSymbolByID(tx *gorm.DB, id uint) (*entity.OrderSymbol, error)
	FindManyOrderByUUID(tx *gorm.DB, uuids []string) ([]*entity.OrderBook, error)
	FindRecentIntervalByName(tx *gorm.DB, name string) (*entity.OrderInterval, error)
