...
type UserDormant struct {
	...
	MetadataProfile types.Metadata `gorm:"type:json;comment:'프로필 메타데이터';not null;" json:"metadataProfile"`
	MetadataUser    types.Metadata `gorm:"type:json;comment:'유저 메타데이터';not null;" json:"metadataUser"`
