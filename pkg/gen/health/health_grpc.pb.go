...
func (c *healthCheckClient) Check(ctx context.Context, in *HealthCheckInput, opts ...grpc.CallOption) (*HealthCheckOutput, error) {
	...
	err := c.cc.Invoke(ctx, "/health.HealthCheck/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthCheckClient) WhoAmI(ctx context.Context, in *WhoAmIInput, opts ...grpc.CallOption) (*WhoAmIOutput, error) {
	...
	err := c.cc.Invoke(ctx, "/health.HealthCheck/WhoAmI", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HealthCheck_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/health.HealthCheck/Check",
	}
...
func _HealthCheck_WhoAmI_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/health.HealthCheck/WhoAmI",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
