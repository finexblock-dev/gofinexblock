...
type Repository interface {
	...
	ScanCoinTransferByCond(tx *gorm.DB, userID, coinID uint, limit, offset int) (result []*entity.CoinTransfer, err error)
...
type Service interface {
	...
	ScanCoinTransferByCond(userID, coinID uint, limit, offset int) (result []*entity.CoinTransfer, err error)
